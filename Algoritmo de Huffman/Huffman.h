...
int* frec;
void ProcesarFrecuencias(ifstream &input){
	frec = new int[258];
...
void OrdenaFrecuencias(cola &ColaPrioridad){
...
int main(int argc, char* argv[]) {
	...
	if (argc == 2){
		...
		cola ColaPrioridad = cola(); //la cola almacena un par (frecuencia, Nodo*caracter)
